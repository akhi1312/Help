...
var autoIncrement = require('mongoose-auto-increment'); //import Mongoose autoIncrement plugin
mongoose.Promise = global.Promise; //promises
...
// User Phone Validator Validator
var phoneNumber = [

    validate({
        validator: 'isLength',
        arguments: [10, 10],
        message: 'Phone Number should be of  {ARGS[0]}  digit'
    })
];
...
var UserSchema = new Schema({
    ...
    phoneNumber: {type : String , required:true , unique:true ,validate : phoneNumber},
    city : String,
    active: { type: Boolean, required: true, default: false },
    temporarytoken: { type: String, required: true },
    resettoken: { type: String, required: false },
    permission: { type: String, required: true, default: 'user' },
    badges: [{ title: String, date: Date, description: String }],//Rahil Modi
    skills: [String]
});
